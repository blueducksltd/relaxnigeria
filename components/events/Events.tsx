    ...
    return (
        <main className='my-20 md:my-44 overflow-hidden'>
            ...
            <section className='flex flex-col justify-center items-center mb-12 md:mb-16 gap-6 text-center px-10 md:px-96'>
                ...
                <div className='bg-white w-full p-5 rounded-full'>
            ...
            <section className='px-6 md:px-20 bg-[#FBFFDD] py-20 md:py-24'>
                <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-8'>
                    {/* Event 1 */}
                    {[...events, ...events, ...events, ...events, ...events, ...events].map((event) => (
                        <div className='flex flex-col group'>
                            <div className={`bg-[url(${event.image})] bg-cover bg-center w-full aspect-4/3.5 md:h-[348px] rounded-2xl md:rounded-3xl shadow-md group-hover:shadow-xl group-hover:scale-[1.01] transition-all duration-500`}></div>
