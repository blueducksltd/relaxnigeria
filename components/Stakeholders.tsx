        ...
        <main className='px-6 md:px-20 bg-darkgreen py-20 md:py-24 my-20 md:my-44 overflow-hidden'>
            <section className='flex flex-col lg:flex-row items-center justify-between gap-12'>
                ...
                <div className='flex flex-col items-center lg:items-end lg:order-last text-center lg:text-right'>
                    ...
                    <p className='font-laybar text-5xl md:text-6xl mt-2 text-[#FBFFDD] leading-tight'>Meet the <br className="hidden md:block" /> Stakeholders</p>
                </div>

                {/* Bubble Layout Wrapper */}
                <div className='w-full max-w-4xl overflow-x-auto lg:overflow-visible pb-8 lg:pb-0 scrollbar-hide'>
                    <div className='flex flex-col gap-4 md:gap-5 min-w-[320px]'>
                        {/* Row 1 */}
                        <div className='flex items-center gap-3 md:gap-5 justify-center lg:justify-start'>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#2E7043] rounded-full shrink-0'></div>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[url(/governor.png)] bg-cover rounded-full shrink-0 shadow-lg border-2 border-milk/10'></div>
                            <div className='w-44 md:w-80 h-20 md:h-36 bg-lightgreen rounded-full flex flex-col items-start justify-center pl-4 md:pl-7 shrink-0 shadow-lg'>
                        ...
                        {/* Row 2 */}
                        <div className='flex items-center gap-3 md:gap-5 justify-center lg:justify-start'>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#50755C] rounded-full shrink-0'></div>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#2E7043] rounded-full shrink-0'></div>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#50755C] rounded-full shrink-0'></div>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#2E7043] rounded-full shrink-0'></div>
                        </div>
                        ...
                        {/* Row 3 */}
                        <div className='flex items-center gap-3 md:gap-5 justify-center lg:justify-start'>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[url(/seyi.png)] bg-cover rounded-full shrink-0 shadow-lg border-2 border-milk/10'></div>
                            <div className='w-44 md:w-80 h-20 md:h-36 bg-lightgreen rounded-full flex flex-col items-start justify-center pl-4 md:pl-7 shrink-0 shadow-lg'>
                        ...
                        <div className='flex items-center gap-3 md:gap-5 justify-center lg:justify-start'>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[#50755C] rounded-full shrink-0'></div>
                            <div className='w-20 h-20 md:w-36 md:h-36 bg-[url(/johnson.png)] bg-cover rounded-full shrink-0 shadow-lg border-2 border-milk/10'></div>
                            <div className='w-44 md:w-80 h-20 md:h-36 bg-lightgreen rounded-full flex flex-col items-start justify-center pl-4 md:pl-7 shrink-0 shadow-lg'>
